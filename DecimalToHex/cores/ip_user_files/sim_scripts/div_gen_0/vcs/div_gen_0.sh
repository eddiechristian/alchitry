...
design_libs=(xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_23 floating_point_v7_0_25 div_gen_v5_1_24 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work floating_point_v7_0_25 $vhdlan_opts \
  "../../../ipstatic/hdl/floating_point_v7_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work div_gen_v5_1_24 $vhdlan_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/eddie/alchitry/DecimalToHex/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
