...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_23 -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 -log elaborate.log
}
