...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/seven_seg_digit.sv" "./source/seven_seg_multiplexer.sv" "./source/lucid_globals.sv" ]
